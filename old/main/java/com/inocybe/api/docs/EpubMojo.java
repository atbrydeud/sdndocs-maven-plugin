  ...
  extends com.agilejava.docbkx.maven.AbstractEpubMojo
{
  ...
  public void preProcess() throws MojoExecutionException {
        ...
        //
        com.inocybe.api.docs.FileUtils.extractJaredDirectory("images", PDFMojo.class, imageParentDirectory);
        setImageDirectory (new File (imageParentDirectory, "images"));

        //
        // Extract all fonts into fonts directory
        //
        com.inocybe.api.docs.FileUtils.extractJaredDirectory("fonts", PDFMojo.class, imageParentDirectory);
    }
