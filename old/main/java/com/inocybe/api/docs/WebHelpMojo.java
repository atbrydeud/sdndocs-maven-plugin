...
import com.inocybe.api.docs.builders.PDFBuilder;
...
public abstract class WebHelpMojo extends AbstractWebhelpMojo {
     ...
     */
    private String builtForOpenDaylight;
	...
	if (null != builtForOpenDaylight) {
	    transformer.setParameter("builtForOpenStack", builtForOpenDaylight);
	}
   ...
   transformer.setParameter("compute.wadl.path.from.docbook.path",computeWadlPathFromDocbookPath);
	...
	if(null != webhelpWar && !"0".equals(webhelpWar)){
		...
		com.inocybe.api.docs.FileUtils.addDirectory(zout, sourceDir);
    ...
    protected void copyTemplate(File result) throws MojoExecutionException {
        ...
        com.inocybe.api.docs.FileUtils.extractJaredDirectory("content", WebHelpMojo.class, targetDirectory);
        com.inocybe.api.docs.FileUtils.extractJaredDirectory("common", WebHelpMojo.class, targetDirectory);
    ...
    public void preProcess() throws MojoExecutionException {
        ...
        if (!targetDirectory.exists()) {
            com.inocybe.api.docs.FileUtils.mkdir(targetDirectory);
        }

        //
        // Extract all images into the image directory.
        //
        com.inocybe.api.docs.FileUtils.extractJaredDirectory("sdn/war",PDFMojo.class,xslParentDirectory);
        com.inocybe.api.docs.FileUtils.extractJaredDirectory("sdn/webhelp",PDFMojo.class,xslParentDirectory);
    }
		...
		pdfBuilder.setTocSectionDepth(getProperty("tocSectionDepth"));
		    ...
		    File targetDirForPdf = ((File)map.get("targetHtmlContentDir")).getParentFile();
        		if(!targetDirForPdf.exists()) {
        			com.inocybe.api.docs.FileUtils.mkdir(targetDirForPdf);
        		}
