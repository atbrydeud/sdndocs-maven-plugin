...
@@@@@@@@@@@@@@@@@@@@@@
    ...
    <p:declare-step 
        ...
        <p:xslt name="programlisting-keep-together-xslt">
            ...
            <p:input port="stylesheet">
                ...
                <!--<p:document href="sdn/code-listing-keep-together.xsl"/>-->
            </p:input>
            <p:input port="parameters" >
                <p:empty/>
            </p:input>
    ...
    <p:declare-step 
        ...
        <p:xslt name="xhtml2docbook">
            ...
            <p:input port="stylesheet">
                ...
                <!--<p:document href="sdn/process-embedded-wadl.xsl"/>-->
            </p:input>
            <p:input port="parameters" >
                <p:empty/>
            </p:input>
    ...
    <p:declare-step 
        ...
        <p:xslt name="extensions-info-xslt">
            ...
            <p:input port="stylesheet">
                <p:document href="classpath:///sdn/extensions.xsl"/>
            </p:input>
            <p:input port="parameters" >
    ...
    <p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
        ...
        <p:group name="group">
            ...
            <p:xslt name="lists-files">
                ...
                <p:input port="stylesheet">
                    <p:document href="classpath:///sdn/list-wadls.xsl"/>
                </p:input>
                <p:input port="parameters">
				...
				<xsl:if test="not(@db:security) or @db:security = $security">
				  <xsl:copy>
                    ...
                    <p:xslt name="normalize-wadl">  
                        ...
                        <p:input port="stylesheet">
                            <p:document href="classpath:///sdn/normalizeWadl/normalizeWadl.xsl"/>
                        </p:input>
...
+-->    
    ...
    <p:declare-step 
        ...
        <p:xslt name="process-embedded-wadl-xslt-1">
            ...
            <p:input port="stylesheet">
                <p:document href="classpath:///sdn/process-embedded-wadl-1.xsl"/>
            </p:input>
            <p:input port="parameters" >
        ...
        <p:xslt name="process-embedded-wadl-xslt-2">
            ...
            <p:input port="stylesheet">
                <p:document href="classpath:///sdn/process-embedded-wadl-2.xsl"/>
            </p:input>
            <p:input port="parameters" >
                <p:pipe step="process-embedded-wadl-step" port="parameters"/>
            </p:input>
        ...
        <p:xslt name="process-embedded-wadl-xslt-3">
            ...
            <p:input port="stylesheet">
                <p:document href="classpath:///sdn/process-embedded-wadl-3.xsl"/>
            </p:input>
            <p:input port="parameters" >
                <p:pipe step="process-embedded-wadl-step" port="parameters"/>
            </p:input>
    ...
    <p:declare-step 
	  ...
	  <p:pipe step="generate-war-xslt" port="result"/>
        ...
        <p:xslt name="generate-war-xslt">
            ...
            <p:input port="stylesheet">
                <p:document href="target/docbkx/sdn/war/docbook.xsl"/>
            </p:input>
            <p:input port="parameters" >
        ...
        <p:for-each>
            ...
            <p:choose>
                ...
                <p:otherwise>
                    <p:xslt>
                        <p:input port="stylesheet">
                            <p:document href="target/docbkx/sdn/war/xhtml2html.xsl"/>
                        </p:input>
                    </p:xslt>
                   <!--
    ...
    <p:declare-step 
        ...
        <p:xslt name="process-embedded-wadl-xslt">
            ...
            <p:input port="stylesheet">
                <p:document href="classpath:///sdn/process-embedded-wadl-standalone.xsl"/>
            </p:input>
            <p:input port="parameters" >
    ...
    <p:declare-step 
        ...
        <p:xslt name="add-stop-chunking-pis-xslt">
            ...
            <p:input port="stylesheet">
                <p:document href="classpath:///sdn/war/add-stop-chunking-pis.xsl"/>
            </p:input>
            <p:input port="parameters" >
